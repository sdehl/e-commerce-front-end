            ...
            <div className="d-flex flex-column mt-5 mb-3">
              ...
              {dolarsSelected && (
                <h5 className="textLighter">
                  Realiza tu pago directamente en nuestra cuenta bancaria, Itaú. Por favor, utiliza
                  el número de pedido y nombre como referencia de pago. Tu pedido no se procesará
                  hasta que se haya recibido el importe en nuestra cuenta. Luego mande captura de
                  pantalla al Whatsapp: +598 99 149 592
                </h5>
              )}
            </div>
            <ColoredLine color="gray" />
          ...
          {errorMessage && (
            <>
              <p className="m-2 fst-italic">
                Error en crear orden, repase su información. Puede que ya no haya stock de alguno de
                      ...
                      <div key={product._id}>
                        ...
                        <div className="d-flex mt-4 mb-4 productosFaltantes">
                          ...
                          <div className="d-flex flex-column justify-content-center">
                            ...
                            <h6 className="m-2">CANTIDAD DE STOCK RESTANTE: {product.stockLeft}</h6>
                          </div>
                        </div>
                      </div>
                    );
